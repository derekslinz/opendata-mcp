...
REGISTRY: tuple[ProviderEntry, ...] = (
    ...
    ProviderEntry(
        ...
        regions=("us",),
        keywords=("healthdata", "hhs", "health", "socrata", "public health", "insurance"),
    ...
    ProviderEntry(
        ...
        regions=("us",),
        keywords=("north carolina", "nc", "arcgis", "onemap", "gis", "geographic"),
    ...
    ProviderEntry(
        ...
        regions=("us",),
        keywords=("ncdeq", "denr", "north carolina", "environment", "gis", "arcgis", "air quality", "water"),
