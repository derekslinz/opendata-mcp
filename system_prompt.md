...
1. **Discover**: Start by using the `opendata_mcp_meta` provider tools (like `find-providers`, `list-domains`, or `list-providers`) to search for the right provider for the user's question.
