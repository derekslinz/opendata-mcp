...
async def test_pdb_entry_success():
    with patch("httpx.get") as mock_get:
        mock_get.return_value.json.return_value = {"rcsb_id": "4HHB", "struct": {"title": "Hemoglobin"}}
...
async def test_pdb_polymer_success():
    with patch("httpx.get") as mock_get:
        mock_get.return_value.json.return_value = {"rcsb_id": "4HHB_1", "rcsb_polymer_entity": {"details": "Alpha chain"}}
        mock_get.return_value.raise_for_status = Mock()
